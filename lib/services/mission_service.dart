...
/// Service untuk mengelola misi harian
/// Bertanggung jawab untuk memuat, meng-generate, dan mengupdate progress misi
  ...
  Future<void> checkAndResetDailyMissions() async {
    ...
    try {
      ...
      if (activeMissions.isEmpty) {
        debugPrint('Tidak ada misi untuk hari ini, generating...');
